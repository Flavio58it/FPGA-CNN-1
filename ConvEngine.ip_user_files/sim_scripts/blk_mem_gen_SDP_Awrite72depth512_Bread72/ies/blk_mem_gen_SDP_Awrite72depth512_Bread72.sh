...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.blk_mem_gen_SDP_Awrite72depth512_Bread72 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.blk_mem_gen_SDP_Awrite72depth512_Bread72 -input simulate.do
}
# Script usage
usage()
{
