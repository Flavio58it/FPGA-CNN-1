...
# executing this script. Please type 'blk_mem_gen_SDP_Awrite72depth512_Bread72.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_SDP_Awrite72depth512_Bread72_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc blk_mem_gen_SDP_Awrite72depth512_Bread72_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/./../../../../ConvEngine.srcs/sources_1/ip/blk_mem_gen_SDP_Awrite72depth512_Bread72/sim/blk_mem_gen_SDP_Awrite72depth512_Bread72.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.blk_mem_gen_SDP_Awrite72depth512_Bread72 -o blk_mem_gen_SDP_Awrite72depth512_Bread72_simv
}
...
simulate()
{
  ...
  ./blk_mem_gen_SDP_Awrite72depth512_Bread72_simv $opts -do simulate.do
}
# Script usage
usage()
{
