...
HD_PWD=/home/edcn103/Dropbox/M.tech/Project/Hardware_Implementation/ConvEngine/ConvEngine.runs/blk_mem_gen_0_True_Dual_Port_synth_1
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_0_True_Dual_Port.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_0_True_Dual_Port.tcl
