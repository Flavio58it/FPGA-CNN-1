...
HD_PWD=/home/edcn103/Dropbox/M.tech/Project/Hardware_Implementation/ConvEngine/ConvEngine.runs/fifo_generator_Width320_Depth16_DistRAM_synth_1
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_Width320_Depth16_DistRAM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_generator_Width320_Depth16_DistRAM.tcl
