...
HD_PWD=/home/edcn103/Dropbox/M.tech/Project/Hardware_Implementation/ConvEngine/ConvEngine.runs/blk_mem_gen_SDP_Awrite36depth2048_bread36_synth_1
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_SDP_Awrite36depth2048_bread36.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_SDP_Awrite36depth2048_bread36.tcl
