...
HD_PWD=/home/edcn103/Dropbox/M.tech/Project/Hardware_Implementation/ConvEngine/ConvEngine.runs/xbip_dsp48_macro_Test_synth_1
cd "$HD_PWD"
...
EAStep vivado -log xbip_dsp48_macro_Test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xbip_dsp48_macro_Test.tcl
