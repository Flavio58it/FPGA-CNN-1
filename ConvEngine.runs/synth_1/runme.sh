...
HD_PWD=/home/edcn103/Dropbox/M.tech/Project/Hardware_Implementation/ConvEngine/ConvEngine.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log ConvEngineOutput_Top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ConvEngineOutput_Top.tcl
